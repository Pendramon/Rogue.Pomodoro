...
[System.Diagnostics.CodeAnalysis.SuppressMessage("Design", "CA1069:Enums values should not be duplicated", Justification = "Ask Microsoft.")]
...
#pragma warning restore SA1602 // Enumeration items should be documented
    ...
    /// If the application is a 16-bit application,
    /// the idChild parameter is CONSOLE_APPLICATION_16BIT and
    /// idObject is the process identifier of the NTVDM session associated with the console.
    /// </summary>
